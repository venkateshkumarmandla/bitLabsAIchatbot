...
// import Employee from "../../images/dashboard/mobilebanners/employee 1.png";
// import Line from "../../images/dashboard/mobilebanners/Line 15.png"
...
//                   </div>
//                 </div>
//                 <div class="col-12 col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12 display-flex certificatebox">
//                   <div className=" card"  style={{
//           background: 'linear-gradient(90deg, #FF8C00 0%, #FFA500 100%)', padding:"18px"}}>
//       <div
...
//     objectFit: 'contain',
//     marginLeft: '10px',
//     marginTop: '-22px', // 10% of 220px = ~22px upward overlap
//   }}
...
//         <div className="flex-grow-1" style={{ minWidth: '250px', padding: '10px' }}>
...
//           <img src={Line} alt="Divider" style={{ height: '100px', width: '1px' }} />
//         </div>

//         {/* Right: Employee + Stats */}
//         <div style={{ display: 'flex', alignItems: 'center', gap: '10px', paddingRight: '20px' }}>
//           <img src={Employee} alt="Employee Icon" style={{ height: '45px', width: '45px' }} />
//           <div>
//             {/* <div style={{ fontSize: '20px', fontWeight: '700' }}>7,846+</div> */}
        
//                           <div style={{ fontSize: '20px', fontWeight: '700' }}>{hiredCount}+</div>

//             <div style={{ fontSize: '14px' }}>Candidates Placed</div>
//           </div>
//         </div>
//       </div>
//     </div>
...
//       paddingBottom:"0px",
//       margin:"20px",
//       alignItems: isWideScreen ? '' : 'center',
//       justifyContent: isWideScreen ? 'auto' : 'center',
//       height: isWideScreen ? '170px' : 'auto', // Adjust height for mobile view
...
//       {/* Middle: Text + App Links */}
//       <div className="flex-grow-1 text-center text-md-start" style={{ minWidth: '250px', padding: '10px',alignItems: isWideScreen ? '' : 'center',
//       justifyContent: isWideScreen ? 'auto' : 'center', }}>
//         <p style={{ margin: 0, fontSize: '16px', color: '#fff' }}>
//           Why open laptop when jobs can be right in your pocket.
//         </p>
...
//       <div className="d-none d-md-block" style={{ padding: '0 20px' }}>
//         <svg width="2" height="123" viewBox="0 0 1 163" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//           paddingRight: '20px',
//           marginTop: '20px',
//           alignItems: isWideScreen ? 'auto' : 'center',
//       justifyContent: isWideScreen ? 'auto' : 'center',
//         }}
//       >
//         {/* SVG Icon */}
  ...
  bottom: '-20px',
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: '14px', fontWeight: '700', color: '#fff' }}>Candidates Placed</div>
        </div>
      </div>
    </div>
  </div>
